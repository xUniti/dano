...
export const nav: NavItem[] = [
	...
	{ href: '/persona', label: 'Persona', icon: Users, ready: false },
	{ href: '/tasks', label: 'Tasks', icon: ListChecks, ready: false, primary: true },
	...
	{ href: '/habits', label: 'Habits', icon: Flame, ready: false, primary: true },
